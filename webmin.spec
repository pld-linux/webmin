...
Summary(pl.UTF-8):   Webmin - Zarządzanie quota
Group:		Applications/System
Requires:	quota
Prereq:		webmin
...
Summary(pl.UTF-8):   Webmin - Narzędzia administracyjne (telnet, menadżer plików, itp.)
Group:		Applications/System
Prereq:		webmin
...
Webmin - Narzędzia administracyjne (telnet, menadżer plików, itp.).
...
#Summary(pl.UTF-8):   Webmin - Zarządzenia procesami
Group:		Applications/System
Prereq:		webmin
...
Summary(pl.UTF-8):   Webmin - Zmiany haseł
Group:		Applications/System
Requires:	webmin-useradmin = %{version}
Prereq:		webmin
...
Summary(pl.UTF-8):   Webmin - Obsługa kont użytkowników
Group:		Applications/System
Prereq:		webmin
